...
export default function initModels(sequelize) {
  ...
  COCKTAIL.belongsToMany(USER, {
    as: 'UNO_USERs',
    through: COCKTAIL_LIKE,
    foreignKey: 'CNO',
    otherKey: 'UNO',
  });
  COCKTAIL.belongsToMany(USER, {
    as: 'UNO_USER_COCKTAIL_REPORTs',
    through: COCKTAIL_REPORT,
    foreignKey: 'CNO',
    otherKey: 'UNO',
  });
  POST.belongsToMany(USER, {
    as: 'UNO_USER_POST_LIKEs',
    through: POST_LIKE,
    foreignKey: 'PNO',
    otherKey: 'UNO',
  });
  POST.belongsToMany(USER, {
    as: 'UNO_USER_POST_REPORTs',
    through: POST_REPORT,
    foreignKey: 'PNO',
    otherKey: 'UNO',
  });
  ...
  USER.belongsToMany(COCKTAIL, {
    as: 'CNO_COCKTAIL_COCKTAIL_REPORTs',
    through: COCKTAIL_REPORT,
    foreignKey: 'UNO',
    otherKey: 'CNO',
  });
  ...
  COCKTAIL_REPORT.belongsTo(COCKTAIL, {
    as: 'CNO_COCKTAIL',
    foreignKey: 'CNO',
  });
  COCKTAIL.hasMany(COCKTAIL_REPORT, {
    as: 'COCKTAIL_REPORTs',
    foreignKey: 'CNO',
  });
  ...
  cocktaildb_recipeset.belongsTo(cocktaildbset, {
    as: 'CNO_cocktaildbset',
    foreignKey: 'CNO',
  });
  cocktaildbset.hasMany(cocktaildb_recipeset, {
    as: 'cocktaildb_recipesets',
    foreignKey: 'CNO',
  });
